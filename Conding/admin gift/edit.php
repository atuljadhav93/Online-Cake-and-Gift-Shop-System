...
//select record
$result=mysql_query("SELECT * FROM admingift where gid=".$_GET['id']."");
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td><input type="submit" name="sub" value="Add">
      <a href="index.php" style="text-decoration:none;">Gift List</a></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
//Update Query
 if(isset($_POST['sub']))
{
$sql=("update admingift set price1='".$_POST['price1']."',price2='".$_POST['price2']."',availability='".$_POST['availability']."',name='".$_POST['name']."' where gid=".$_GET['id']."");
if(!mysql_query($sql))
{
