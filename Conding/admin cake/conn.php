...
$sel=mysql_query("select * from admincake");
 ...
 echo " <tr>
		...
		<td>".$row['name']."</td>
        <td><a href=\"index.php?page=viw&rid=".$row['cid']."\">V</a></td>
        <td><a href=\"index.php?page=edt&rid=".$row['cid']."\">E</a></td>
...
function del_row()
{
if(mysql_query("delete from admincake where id=".$_GET['cid']))
...
function viw_row()
{
	$sel=mysql_query("select * from admincake where id=".$_GET['cid']."");
