...
<table width="100%" border="1">
  ...
  <tr>
    <td>&nbsp;</td>
    <td valign="middle" align="right">Flavor Name</td>
    <td>:</td>
...
$mysql="INSERT INTO admincake(price1,price2,availability,name) values('".$_POST['price1']."','".$_POST['price2']."','".$_POST['availability']."','".$_POST['name']."')";
